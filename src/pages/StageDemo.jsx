...
export default function StageDemo() {
  ...
  useEffect(() => {
    const handleKey = (e) => {
      ...
      if (e.code === 'KeyM') {
        setArtifactHtml(`<!DOCTYPE html><html><head><style>
          ...
          <p>Hey there! This is a sample newsletter preview to test the artifact panel layout. The real content will be generated by your AI CEO agent.</p>
          <p>This panel should stay open while the voice orb remains active on the left side.</p>
          <a class="cta" href="#">Subscribe Now</a>
        </body></html>`);
        setArtifactTitle('Sample Newsletter');
        setPhase('artifact');
      }
    };
